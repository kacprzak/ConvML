...
\begin{abstract}
  ...
  \href{http://www.entertech.com.pl/convml/convml_11.xsd}{entertech.com.pl/convml/convml_11.xsd}.
\end{abstract}
...
jej zwrot jest zgodny z kierunkiem biegu taśmy. Środek układu współrzędnych
jest przesunięty. Zakładając że $(x_0, y_0)$ to środek układu współrzędnych elementu
...
a także zmniejszenie oporów ruchu przenośnika oraz właściwe podtrzymywanie transportowanego
...
atrybutu typeId.  Nie jest dopuszczalne przedefiniowanie atrybutów zdefiniowanych
w typie
...
Element Meta umożliwia zapisanie dodatkowych informacji o dokumencie. Jest jedynym elementem
w którego strukturze występują węzły tekstowe.
...
\item[typeDescription] Opis typu. Ten opis nie zostanie nadpisany przez atrybut description
	w instancji odwołującej się do typu.
\item[manufacturer] Producent elementów należących do opisywanego typu. 
\end{description}

\subsection{lengthAngleGroup}
Atrybuty elementów mających długość i kąt nachylenia. Wspólne dla stacji zwrotnej, stacji czołowej
oraz odcinków trasy. 
