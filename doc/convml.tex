...
\begin{abstract}
  ...
  do zapisu strukturalnego modelu przenośnika taśmowego w formacie XML \cite{XML10}.
...
Głównym elementem dokumentu jest \verb|ConvML|.  Podelementy \verb|Meta| oraz \verb|Types| są
opcjonalne. Element \verb|BeltConveyor| musi wystąpić co najmniej raz aby dokument był
...
\noindent\textbf{Definicje atrybutów:}
\begin{description}
...
napinania taśmy, taśma, trasa, zestawy krążnikowe i krążniki \cite{Antoniak2005}.
...
napięcia taśmy i na zapotrzebowanie mocy napędu \cite{Antoniak2005}.  W języku ConvML
