...
reprezentacji w konstrukcji przenosnika taśmowego. Element ten definiuje
strukturę, zgodnie z którą taśma przenosnikowa jest listą naprzemiennie
występujących elementów BeltSegment oraz BeltSplice, gdzie połorzenie tych
elementów w dokumencie odzwierciedla połorzenie odcinków i złącz w rzeczywistej
...
4 oraz złączem 1 z odcinkiem taśmy 2. W naprostszym przypadku może być jedno
...
bezpośrednio w elemencie BeltSegment lub elemencie BeltSegmentType do ktorego
...
elementu Belt. W poprawnym dokumentcie będą to zawsze elementy BeltSegment
reprezentujące odcinki taśmy. Złącze w przeciwieństwie do odcinka nie posiada
parametru długości i jest rozpatrywane jako miejsce (punkt) wykonania połączenia.
...
\item[spliceType] Rodzaj zlącza np: wulkanizowane, mechaniczne, klejone, inne.
\end{description}
